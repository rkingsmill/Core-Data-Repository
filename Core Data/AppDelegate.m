...
//  Core Data
//
//  Created by Rosalyn Kingsmill on 2016-05-21.
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    NSManagedObject *personDelete = (NSManagedObject *)[result objectAtIndex:0];
    
    [self.managedObjectContext deleteObject:personDelete];
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "Lighthouse-Labs.Core_Data" in the application's documents directory.
